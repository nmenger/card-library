...
class TestStandardHandOfCards {
	...
	private static final StandardCard SEVEN_DIAMONDS = new StandardCard(StandardCardSuit.DIAMOND,
			StandardCardRank.SEVEN);
	...
	@Test
	void testIsStraight() {
		StandardHandOfCards hand = new StandardHandOfCards(ACE_SPADES, ACE_CLUBS, TWO_CLUBS, THREE_DIAMONDS,
				FOUR_DIAMONDS);
